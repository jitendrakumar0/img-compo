...
import component1 from '../../assets/img/stacked.png'
import calendars from '../../assets/img/calendars.png'
import commandpalettes from '../../assets/img/command-palettes.png'
import formlayouts from '../../assets/img/form-layouts.png'
import pageheadings from '../../assets/img/page-headings.png'
import pagination from '../../assets/img/pagination.png'
import sidebar from '../../assets/img/sidebar.png'
import signinforms from '../../assets/img/sign-in-forms.png'
import steps from '../../assets/img/steps.png'
import tables from '../../assets/img/tables.png'
import inputgroups from '../../assets/img/input-groups.png'
...
const Uicomponents = () => {
  return (
    <>
        <section className='relative lg:pt-20 md:pt-16 pt-12 pb-8'>
            <div className='mx-auto max-w-7xl p-6 lg:px-8'>
                <div className="max-w-2xl">
                    <div className="text-base font-semibold leading-7 text-indigo-600">Components</div>
                    <div className="mt-4 text-4xl font-extrabold tracking-tight text-slate-900">Beautifully crafted UI components, ready for your next project.</div>
                </div>
                <div className="max-w-xl">
                    <div className="mt-4 text-base leading-7 text-slate-700">Over 500+ professionally designed, fully responsive, expertly crafted component examples you can drop into your Tailwind projects and customize to your heart’s content.</div>
                </div>
                <div className="mt-6">
                    <a className="text-base font-semibold text-indigo-600 hover:text-indigo-700" href="/components">Browse all components <span aria-hidden="true">→</span></a>
                </div>
            </div>
        </section>
                ...
                <Tab.List className="flex items-center gap-3">
                    <Tab className="focus-visible:outline-none">
                        <div>
                            <div className="relative -mt-px border-t pb-6 pt-4 text-left md:pb-10 md:pt-8 border-indigo-500">
                                <div>
                                    <button className="whitespace-nowrap text-sm font-semibold leading-7 sm:text-base [&amp;:not(:focus-visible)]:focus:outline-none text-indigo-600" >
                                        <span className="absolute inset-0 -top-px"> </span>Application UI
                                    </button>
                                </div>
                                    <div className="mt-2 hidden text-sm leading-6 text-slate-700 md:block">Form layouts, tables, dialogs — everything you need to build beautiful responsive web applications.</div>
                            </div>
                        </div>
                    </Tab>
                    <Tab  className="focus-visible:outline-none">
                        <div>
                            <div className="relative -mt-px border-t pb-6 pt-4 text-left md:pb-10 md:pt-8 border-indigo-500 outline-none focus-visible:outline-none">
                                <div>
                                    <button className="whitespace-nowrap text-sm font-semibold leading-7 sm:text-base focus:outline-none [&:not(:focus-visible)]:focus:outline-none text-slate-900">
                                        <span className="absolute inset-0 -top-px"> </span>Application UI
                                    </button>
                                </div>
                                    <div className="mt-2 hidden text-sm leading-6 text-slate-700 md:block">Form layouts, tables, dialogs — everything you need to build beautiful responsive web applications.</div>
                    ...
                    <Tab  className="focus-visible:outline-none">
                        <div>
                            <div className="relative -mt-px border-t pb-6 pt-4 text-left md:pb-10 md:pt-8 border-indigo-500">
                                <div>
                                    <button className="whitespace-nowrap text-sm font-semibold leading-7 sm:text-base [&:not(:focus-visible)]:focus:outline-none text-slate-900 focus:outline-none">
                                        <span className="absolute inset-0 -top-px"> </span>Application UI
                                    </button>
                                </div>
                                    <div className="mt-2 hidden text-sm leading-6 text-slate-700 md:block">Form layouts, tables, dialogs — everything you need to build beautiful responsive web applications.</div>
                ...
                <Tab.Panels>
                    <Tab.Panel>
                        <div className='relative mt-10 md:mt-0'>
                            <ul className='grid grid-cols-[repeat(auto-fill,minmax(12rem,1fr))] gap-x-8 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4'>
                                <li className=''>
                                    <div class="group relative before:absolute before:-inset-2.5 before:rounded-[20px] before:bg-gray-50 before:opacity-0 hover:before:opacity-100">
                                        <div className="relative aspect-[2/1] overflow-hidden rounded-lg bg-gray-100 ring-1 ring-gray-900/10">
                                            <img src={component1} alt="" class="absolute inset-0 h-full w-full"/>
                                        </div>
                                        <h4 className="mt-4 text-sm font-medium text-slate-900 group-hover:text-indigo-600">
                                            <a href="/components/application-ui/application-shells/stacked"><span class="absolute -inset-2.5 z-10"></span>
                                                <span class="relative">Stacked Layouts</span>
                                            </a>
                                        </h4>
                                ...
                                <li className=''>
                                    <div class="group relative before:absolute before:-inset-2.5 before:rounded-[20px] before:bg-gray-50 before:opacity-0 hover:before:opacity-100">
                                        <div className="relative aspect-[2/1] overflow-hidden rounded-lg bg-gray-100 ring-1 ring-gray-900/10">
                                            <img src={sidebar} alt="" class="absolute inset-0 h-full w-full"/>
                                        </div>
                                        <h4 className="mt-4 text-sm font-medium text-slate-900 group-hover:text-indigo-600">
                                            <a href="/components/application-ui/application-shells/stacked"><span class="absolute -inset-2.5 z-10"></span>
                                                <span class="relative">Sidebar Layouts</span>
                                            </a>
                                        </h4>
                                        <p className="relative mt-1.5 text-xs font-medium text-slate-500">8 components</p>
                                    </div>
                                </li>
                                <li className=''>
                                    <div class="group relative before:absolute before:-inset-2.5 before:rounded-[20px] before:bg-gray-50 before:opacity-0 hover:before:opacity-100">
                                        <div className="relative aspect-[2/1] overflow-hidden rounded-lg bg-gray-100 ring-1 ring-gray-900/10">
                                            <img src={pageheadings} alt="" class="absolute inset-0 h-full w-full"/>
                                        </div>
                                        <h4 className="mt-4 text-sm font-medium text-slate-900 group-hover:text-indigo-600">
                                            <a href="/components/application-ui/application-shells/stacked"><span class="absolute -inset-2.5 z-10"></span>
                                                <span class="relative">Page Headings</span>
                                            </a>
                                        </h4>
                                        <p className="relative mt-1.5 text-xs font-medium text-slate-500">15 components</p>
                                    </div>
                                </li>
                                <li className=''>
                                    <div class="group relative before:absolute before:-inset-2.5 before:rounded-[20px] before:bg-gray-50 before:opacity-0 hover:before:opacity-100">
                                        <div className="relative aspect-[2/1] overflow-hidden rounded-lg bg-gray-100 ring-1 ring-gray-900/10">
                                            <img src={calendars} alt="" class="absolute inset-0 h-full w-full"/>
                                        </div>
                                        <h4 className="mt-4 text-sm font-medium text-slate-900 group-hover:text-indigo-600">
                                            <a href="/components/application-ui/application-shells/stacked"><span class="absolute -inset-2.5 z-10"></span>
                                                <span class="relative">Calendars</span>
                                            </a>
                                        </h4>
                                        <p className="relative mt-1.5 text-xs font-medium text-slate-500">15 components</p>
                                    </div>
                                ...
                                <li className=''>
                                    <div class="group relative before:absolute before:-inset-2.5 before:rounded-[20px] before:bg-gray-50 before:opacity-0 hover:before:opacity-100">
                                        <div className="relative aspect-[2/1] overflow-hidden rounded-lg bg-gray-100 ring-1 ring-gray-900/10">
                                            <img src={tables} alt="" class="absolute inset-0 h-full w-full"/>
                                        </div>
                                        <h4 className="mt-4 text-sm font-medium text-slate-900 group-hover:text-indigo-600">
                                            <a href="/components/application-ui/application-shells/stacked"><span class="absolute -inset-2.5 z-10"></span>
                                                <span class="relative">Tables</span>
                                            </a>
                                        </h4>
                                        <p className="relative mt-1.5 text-xs font-medium text-slate-500">15 components</p>
                                    </div>
                                ...
                                <li className=''>
                                    <div class="group relative before:absolute before:-inset-2.5 before:rounded-[20px] before:bg-gray-50 before:opacity-0 hover:before:opacity-100">
                                        <div className="relative aspect-[2/1] overflow-hidden rounded-lg bg-gray-100 ring-1 ring-gray-900/10">
                                            <img src={formlayouts} alt="" class="absolute inset-0 h-full w-full"/>
                                        </div>
                                        <h4 className="mt-4 text-sm font-medium text-slate-900 group-hover:text-indigo-600">
                                            <a href="/components/application-ui/application-shells/stacked"><span class="absolute -inset-2.5 z-10"></span>
                                                <span class="relative">Form Layouts</span>
                                            </a>
                                        </h4>
                                        <p className="relative mt-1.5 text-xs font-medium text-slate-500">15 components</p>
                                    </div>
                                ...
                                <li className=''>
                                    <div class="group relative before:absolute before:-inset-2.5 before:rounded-[20px] before:bg-gray-50 before:opacity-0 hover:before:opacity-100">
                                        <div className="relative aspect-[2/1] overflow-hidden rounded-lg bg-gray-100 ring-1 ring-gray-900/10">
                                            <img src={inputgroups} alt="" class="absolute inset-0 h-full w-full"/>
                                        </div>
                                        <h4 className="mt-4 text-sm font-medium text-slate-900 group-hover:text-indigo-600">
                                            <a href="/components/application-ui/application-shells/stacked"><span class="absolute -inset-2.5 z-10"></span>
                                                <span class="relative">Input Groups</span>
                                            </a>
                                        </h4>
                                        <p className="relative mt-1.5 text-xs font-medium text-slate-500">15 components</p>
                                    </div>
                                ...
                                <li className=''>
                                    <div class="group relative before:absolute before:-inset-2.5 before:rounded-[20px] before:bg-gray-50 before:opacity-0 hover:before:opacity-100">
                                        <div className="relative aspect-[2/1] overflow-hidden rounded-lg bg-gray-100 ring-1 ring-gray-900/10">
                                            <img src={signinforms} alt="" class="absolute inset-0 h-full w-full"/>
                                        </div>
                                        <h4 className="mt-4 text-sm font-medium text-slate-900 group-hover:text-indigo-600">
                                            <a href="/components/application-ui/application-shells/stacked"><span class="absolute -inset-2.5 z-10"></span>
                                                <span class="relative">Sign-in and Registration</span>
                                            </a>
                                        </h4>
                                        <p className="relative mt-1.5 text-xs font-medium text-slate-500">15 components</p>
                                    </div>
                                ...
                                <li className=''>
                                    <div class="group relative before:absolute before:-inset-2.5 before:rounded-[20px] before:bg-gray-50 before:opacity-0 hover:before:opacity-100">
                                        <div className="relative aspect-[2/1] overflow-hidden rounded-lg bg-gray-100 ring-1 ring-gray-900/10">
                                            <img src={pagination} alt="" class="absolute inset-0 h-full w-full"/>
                                        </div>
                                        <h4 className="mt-4 text-sm font-medium text-slate-900 group-hover:text-indigo-600">
                                            <a href="/components/application-ui/application-shells/stacked"><span class="absolute -inset-2.5 z-10"></span>
                                                <span class="relative">Pagination</span>
                                            </a>
                                        </h4>
                                        <p className="relative mt-1.5 text-xs font-medium text-slate-500">15 components</p>
                                    </div>
                                ...
                                <li className=''>
                                    <div class="group relative before:absolute before:-inset-2.5 before:rounded-[20px] before:bg-gray-50 before:opacity-0 hover:before:opacity-100">
                                        <div className="relative aspect-[2/1] overflow-hidden rounded-lg bg-gray-100 ring-1 ring-gray-900/10">
                                            <img src={steps} alt="" class="absolute inset-0 h-full w-full"/>
                                        </div>
                                        <h4 className="mt-4 text-sm font-medium text-slate-900 group-hover:text-indigo-600">
                                            <a href="/components/application-ui/application-shells/stacked"><span class="absolute -inset-2.5 z-10"></span>
                                                <span class="relative">Steps</span>
                                            </a>
                                        </h4>
                                        <p className="relative mt-1.5 text-xs font-medium text-slate-500">15 components</p>
                                    </div>
                                ...
                                <li className=''>
                                    <div class="group relative before:absolute before:-inset-2.5 before:rounded-[20px] before:bg-gray-50 before:opacity-0 hover:before:opacity-100">
                                        <div className="relative aspect-[2/1] overflow-hidden rounded-lg bg-gray-100 ring-1 ring-gray-900/10">
                                            <img src={commandpalettes} alt="" class="absolute inset-0 h-full w-full"/>
                                        </div>
                                        <h4 className="mt-4 text-sm font-medium text-slate-900 group-hover:text-indigo-600">
                                            <a href="/components/application-ui/application-shells/stacked"><span class="absolute -inset-2.5 z-10"></span>
                                                <span class="relative">Command Palettes</span>
                                            </a>
                                        </h4>
                                        <p className="relative mt-1.5 text-xs font-medium text-slate-500">15 components</p>
                                    </div>
                        ...
                        <div className="pointer-events-none relative z-10 -mt-5 flex justify-center">
                            <a className="inline-flex justify-center rounded-lg text-sm font-semibold py-3 px-4 bg-slate-900 text-white hover:bg-slate-700 pointer-events-auto" href="#"><span>Show more...<span class="sr-only">, Application UI</span></span></a>
                        </div>
                    </Tab.Panel>
                    <Tab.Panel>
                        <div className='relative mt-10 md:mt-0'>
